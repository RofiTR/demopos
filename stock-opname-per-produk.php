                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <td class="orderan-online-button">
                        ...
                        <a href="stock-opname-delete?id=<?= base64_encode($row['stock_opname_id']); ?>&tipe=<?= base64_encode(0);?>" title="Delete Data" onclick="return confirm('Yakin Hapus Data Stock Opname Per Produk ?')">
