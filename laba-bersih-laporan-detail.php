...
<!-- Expense -->
<?php  
    $expense = query("SELECT * FROM expense WHERE expense_cabang = $sessionCabang && expense_date BETWEEN '".$tanggal_awal."' AND '".$tanggal_akhir."' ORDER BY expense_id DESC");
?>
<!-- End Expense -->
        ...
        <div class="container">
            <div class="llb-header">
              ...
              <div class="laporan-laba-bersih-detail">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th colspan="2">4. Expense (Total Dibayar)</th>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><b>Rp <?= number_format($totalExpense, 0, ',', '.'); ?></b></td>
                      </tr>
                      <tr>
                        <td><b>Total Biaya Pengeluaran</b></td>
                        <td>
                            <?php  
                              $totalBiayaPengeluaran = $lb_pengeluaran_gaji + $lb_pengeluaran_listrik + $lb_pengeluaran_tlpn_internet + $lb_pengeluaran_perlengkapan_toko + $lb_pengeluaran_biaya_penyusutan + $lb_pengeluaran_bensin + $lb_pengeluaran_tak_terduga + $lb_pengeluaran_lain + $hutang +$totalExpense;
              ...
              <div class="text-center">
                © <?= date("Y"); ?> Copyright PT. Fanindya Media Kreatif All rights reserved.
              </div>
        </div>
    </section>
