...
<?php  
  if ( $levelLogin !== "super admin" && $levelLogin !== "admin" && $levelLogin !== "kasir" &&$sessionCabang == 0 ) {
    echo "
      <script>
                  ...
                  <tr>
                      ...
                      <td class="orderan-online-button">
                        ...
                        <a href="toko-edit?id=<?= base64_encode($id); ?>" title="Edit Data">
                          ...
                          <a href="toko-delete?id=<?= base64_encode($id); ?>" onclick="return confirm('Yakin Hapus Data Toko ?')" title="Delete Data">
