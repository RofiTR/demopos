          ...
          <div class="col-12">
            <div class="callout callout-info">
              <h5><i class="fas fa-info"></i> Note:</h5>
				      Jika terjadi kesalahan dalam transaksi penjulan barang bisa melakukan Edit QTY di halaman ini. Anda <b style='color:red;'>WAJIB MENYELESAIKAN TRANSAKSI</b> Invoice saat masuk halaman ini
            </div>
