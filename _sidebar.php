<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="bo" class="brand-link">
      <img src="dist/img/logo png.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if ( $levelLogin !== "kasir" && $levelLogin !== "kurir" && $levelLogin !== "admin" ) { ?>
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="expense-data" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Expense</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="expense-laporan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="laporan-saldo-per-channel" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Saldo Per Channel</p>
                </a>
              </li>
            </ul>
            <?php } ?>
