...
<?php  
    ...
    if( isset($_POST["submit"]) ){
      ...
      if( tambahStockOpname($_POST) > 0 ) {
        ...
        echo "
          <script>
            alert('Data Stock Opname Gagal Ditambahkan');
          </script>
        ";
      }
    }
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="callout callout-info">
            ...
            Fitur Stock Opname Keseluruhan <b style='color:red;'>Wajib Untuk Menghentikan Proses Transaksi Penjuaalan & Pembelian</b> Sesuai Tanggal yang dijadwalkan untuk proses stock opname.
        </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <td>
                          <?php  
                            if ( $row['stock_opname_status'] < 1 ) {
                              echo "<b style='color:orange;'>Proses</b>";
                            } else {
                      ...
                      <td class="orderan-online-button">
                        ...
                        <a href="stock-opname-delete?id=<?= base64_encode($row['stock_opname_id']); ?>&tipe=<?= base64_encode(1);?>" title="Delete Data" onclick="return confirm('Yakin Hapus Data Stock Opname Keseluruhan ?')">
