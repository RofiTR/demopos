          ...
          <div class="col-12">
            <div class="callout callout-info">
              <h5><i class="fas fa-info"></i> Note:</h5>
				      Jika terjadi kesalahan dalam transaksi penjulan barang bisa melakukan Edit QTY barang di halaman ini. Anda <b style='color:red;'>WAJIB MENYELESAIKAN TRANSAKSI</b> Invoice saat masuk halaman ini dengan <b style='color:red;'>Klik Tombol Edit Payment</b>.
            </div>
                        ...
                        <table class="table">
                          ...
                          <tr>
                             ...
                             <td class="table-nominal">
                                ...
                                <span>
                                  <?php  
                                      $invoice_pajak_nominal = ($total * $dataTokoLogin['toko_pajak'])/100;
                                  ?>
                                  <?php echo $dataTokoLogin['toko_pajak']; ?>% (<?= $invoice_pajak_nominal; ?>)
                                  <input type="hidden" name="invoice_pajak" value="<?php echo $dataTokoLogin['toko_pajak']; ?>">
                                    <input type="hidden" name="invoice_pajak_nominal" value="<?= $invoice_pajak_nominal; ?>">
                                </span>
                          ...
                          <tr>
                             ...
                             <td class="table-nominal">
                                ...
                                <span>
                                  <?php  
                                    $invoiceSubTotal = $invoice['invoice_ongkir'] + $total + $invoice_pajak_nominal;
                                  ?>
