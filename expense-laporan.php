    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="callout callout-info">
          ...
          Pastikan Anda sudah mengisi Data Operasional Pengeluaran toko. Jika belum silahkan lengkapi <a href="expense-add" style="color: #007bff;"><b>disini</b></a>.
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form role="form" action="expense-laporan-detail" method="POST" target="_blank">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
