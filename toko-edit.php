...
if( isset($_POST["submit"]) ){
  ...
  if( editToko($_POST) > 0 ) {
    ...
    echo "
      <script>
      alert('Anda Belum Melakukan Perubahan Data Toko');
      </script>
    ";
  } else {
    echo "
      <script>
        alert('Data Toko Gagal Diubah');
      </script>
    ";
  }
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        ...
                        <div class="form-group">
                          <label for="toko_print">Lebar Nota Kecil (cm)</label>
						...
						<div class="form-group">
                          <label for="toko_print_besar">Lebar Nota Besar (cm)</label>
                          <input type="number" name="toko_print_besar" class="form-control" id="toko_print_besar" value="<?= $toko['toko_print_besar']; ?>" placeholder="8" required onkeypress="return hanyaAngka1(event)">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="toko_pajak">Pajak (%)</label>
                          <input type="teks" name="toko_pajak" class="form-control decimal-dot" id="toko_pajak" value="<?= $toko['toko_pajak']; ?>" required>
                        </div>
                        <?php  
