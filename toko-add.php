  ...
  if( tambahToko($_POST) > 0 ) {
    echo "
      <script>
        ...
        alert('Data Toko Berhasil Ditambahkan');
      </script>
    ";
  } else {
    echo "
      <script>
        alert('Data Toko Gagal Ditambahkan');
      </script>
    ";
  }
                    ...
                    <div class="col-md-6 col-lg-6">
                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                          ...
                          <input type="number" name="toko_print_besar" class="form-control" id="toko_print_besar"  placeholder="8" required onkeypress="return hanyaAngka1(event)">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="teks" name="toko_pajak" class="form-control decimal-dot" id="toko_pajak"  required>
                        </div>
                        <div class="form-group ">
