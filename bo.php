...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard<b> <?= $dataTokoLogin['toko_nama']; ?></b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div class="small-box" style="background: #fff;">
              ...
              <div class="icon">
                <i class="fas fa-wallet" style="color: #ff4500;"></i>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div class="small-box" style="background: #fff;">
              <div class="inner">
                ...
                <p><b>Jumlah</b> Barang</p>
              </div>
              <div class="icon">
                <i class="fas fa-shopping-basket" style="color: #dc3545;"></i>
              </div>
            </div>
          </div>
  ...
  <section class="kasir-bo">
    <a href="beli-langsung?customer=<?= base64_encode(0); ?>">
      <img src="dist/img/kasir1.png" alt="Techno POS" class="img-fluid"> 
    </a>   
  </section>
