          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="modal-body-button">
                      <h4 style='color:red;'>Harap Diperhatikan</h4>
                      <ol style="margin-left: -20px;">
                          <li>
                            Hapus semua data di file excel template-stock-opname dan biarkan judulnya tetap sama
                          </li>
                          <li>
                            <b style='color:red;'>JANGAN TAMBAHKAN KOLOM BARU</b>
                          </li>
                      </ol>
