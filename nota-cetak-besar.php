...
<html>
<head>
	<title>Nota Cetak POS - Techno POS</title>
	<meta charset=utf-8>
...
<?php foreach ( $toko as $row ) : ?>
    <?php 
    	...
    	$toko_wa   = $row['toko_wa'];
    	$toko_print_besar= $row['toko_print_besar']; 
    ?>
<?php endforeach; ?>

<?php  
	$lebarPrint = $toko_print_besar."cm";
?>
		...
		<div class="nota-box">
			...
			<div class="nota-box-text">
				<div class="row">
					...
					<b>Ongkir :</b> 
					<span class="right-nota">
								Rp.<?= number_format($invoice['invoice_ongkir'], 0, ',', '.'); ?>
							</span>
					</div>
					...
					<b>Diskon :</b>
					<span class="right-nota">
								Rp. <?= number_format($invoice['invoice_diskon'], 0, ',', '.'); ?>
							</span>
					</div>
					...
					<b>Total :</b>
					<span class="right-nota">
								Rp. <?= number_format($invoice['invoice_sub_total'], 0, ',', '.'); ?>
							</span>
					</div>
					...
					<b>DP :</b>
					<span class="right-nota">
								Rp. <?= number_format($invoice['invoice_piutang_dp'], 0, ',', '.'); ?>
							</span>
					</div>
					<?php } ?>
					...
					<span class="right-nota">
								Rp. <?= number_format($invoice['invoice_bayar'], 0, ',', '.'); ?>
							</span>
					</div>
					...
					<span class="right-nota">
							Rp.	<?= number_format($invoice['invoice_kembali'], 0, ',', '.'); ?>	
							</span>
					</div>					
				</div>
			</div>
