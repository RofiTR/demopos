...
function tambahToko($data) {
	...
	$toko_print_besar	= htmlspecialchars($data["toko_print_besar"]);
	$toko_status    	= htmlspecialchars($data["toko_status"]);
	$toko_ongkir    	= htmlspecialchars($data["toko_ongkir"]);
	$toko_pajak     	= htmlspecialchars($data["toko_pajak"]);
	$toko_cabang    	= htmlspecialchars($data["toko_cabang"]);

	
	// query insert data toko
	$query = "INSERT INTO toko VALUES ('', '$toko_nama', '$toko_kota', '$toko_alamat', '$toko_tlpn', '$toko_wa', '$toko_email', '$toko_print' , '$toko_print_besar', '$toko_status', '$toko_ongkir', '$toko_pajak', '$toko_cabang')";
	mysqli_query($conn, $query);
...
function editToko($data) {
	...
	$query = "UPDATE toko SET 
				...
				toko_print_besar    = '$toko_print_besar',
				toko_status     	= '$toko_status',
				toko_ongkir			= '$toko_ongkir',
				toko_pajak      	= '$toko_pajak'
				WHERE toko_id   	= $id
				";
	mysqli_query($conn, $query);
	return mysqli_affected_rows($conn);
...
function updateStock($data) {
	...
	$invoice_pajak       		= $data['invoice_pajak'];
	$invoice_pajak_nominal      = $data['invoice_pajak_nominal'];
	$invoice_ongkir      		= htmlspecialchars($data['invoice_ongkir']);
	$invoice_diskon      		= htmlspecialchars($data['invoice_diskon']);
	
	$invoice_sub_total   		= $invoice_total + $invoice_ongkir + $invoice_pajak_nominal;
	...
	if ( $invoice_piutang == 0 && $invoice_bayar < $invoice_sub_total ) {
		...
		$query1 = "INSERT INTO invoice VALUES ('', '$penjualan_invoice2', '$penjualan_invoice_count', '$invoice_tgl', '$invoice_customer', '$invoice_customer_category', '$invoice_kurir', '1', '$invoice_tipe_transaksi', '$invoice_total_beli', '$invoice_total', '$invoice_pajak', '$invoice_pajak_nominal', '$invoice_ongkir', '$invoice_diskon', '$invoice_sub_total', '$invoice_bayar', '$invoice_kembali', '$kik', '$invoice_date', '$invoice_date_year_month', ' ', ' ', '$invoice_total_beli', '$invoice_total', '$invoice_ongkir', '$invoice_sub_total', '$invoice_bayar', '$invoice_kembali', '$invoice_marketplace', '$invoice_ekspedisi', '$invoice_no_resi', '-', '$invoice_piutang', '$invoice_piutang_dp', '$invoice_piutang_jatuh_tempo', '$invoice_piutang_lunas', 0, '$invoice_cabang')";
		// var_dump($query1); die();
...
function updateStockDraft($data) {
	...
	// query insert invoice
	$query1 = "INSERT INTO invoice VALUES ('', '$penjualan_invoice2', '$penjualan_invoice_count', '$invoice_tgl', '$invoice_customer', '$invoice_customer_category', '$invoice_kurir', '1', '$invoice_tipe_transaksi', '$invoice_total_beli', '$invoice_total', '$invoice_pajak', '$invoice_pajak_nominal', '$invoice_ongkir', '$invoice_diskon', '$invoice_sub_total', '$invoice_bayar', '$invoice_kembali', '$kik', '$invoice_date', '$invoice_date_year_month', ' ', ' ', '$invoice_total_beli', '$invoice_total', '$invoice_ongkir', '$invoice_sub_total', '$invoice_bayar', '$invoice_kembali', '$invoice_marketplace', '$invoice_ekspedisi', '$invoice_no_resi', '-', '$invoice_piutang', '$invoice_piutang_dp', '$invoice_piutang_jatuh_tempo', '$invoice_piutang_lunas', 1, '$invoice_cabang')";
		// var_dump($query1); die();
		mysqli_query($conn, $query1);
...
function updateInvoice($data) {
	...
	$invoice_pajak        = htmlspecialchars($data['invoice_pajak']);
	$invoice_pajak_nominal= htmlspecialchars($data['invoice_pajak_nominal']);
	...
	$invoice_date_edit    = date('Y-m-d');
		...
		$query = "UPDATE invoice SET 
					invoice_total_beli 		= '$invoice_total_beli',
					invoice_total      		= '$invoice_total',
					invoice_pajak 	   		= '$invoice_pajak',
					invoice_pajak_nominal   = '$invoice_pajak_nominal',
					invoice_ongkir     		= '$invoice_ongkir',
					invoice_sub_total  		= '$invoice_sub_total',
					invoice_bayar      		= '$invoice_bayar',
					invoice_kembali    		= '$invoice_kembali',
...
// ========================================= Channel ======================================= //
function tambahChannel($data) {
	global $conn;
	// ambil data dari tiap elemen dalam form
	$cp_name = htmlspecialchars($data['cp_name']);
	$cp_status = $data['cp_status'];
	$cp_cabang = $data['cp_cabang'];

	// query insert data
	$query = "INSERT INTO channel_pembayaran VALUES ('', '$cp_name', '$cp_status', '$cp_cabang')";
	mysqli_query($conn, $query);
...
function editChannel($data) {
	...
	// query update data
	$query = "UPDATE channel_pembayaran SET 
				cp_name   = '$cp_name',
				cp_status = '$cp_status'
				WHERE cp_id = $id
				";
...
function hapusChannel($id) {
	global $conn;
	mysqli_query( $conn, "DELETE FROM channel_pembayaran WHERE cp_id = $id");
...
function tambahExpense($data) {
	global $conn;
	// ambil data dari tiap elemen dalam form
	$expense_name          = htmlspecialchars($data['expense_name']);
	$expense_penerima      = htmlspecialchars($data['expense_penerima']);
	$expense_date          = htmlspecialchars($data['expense_date']);
	$expense_create        = htmlspecialchars($data['expense_create']);
	$expense_desc          = htmlspecialchars($data['expense_desc']);
	$expense_metode 	   = htmlspecialchars($data['expense_metode']);
	$expense_total_tagihan = htmlspecialchars($data['expense_total_tagihan']);
	$expense_total_dibayar = htmlspecialchars($data['expense_total_dibayar']);
	$expense_total_sisa    = $expense_total_dibayar - $expense_total_tagihan ;
	$expense_cabang        = htmlspecialchars($data['expense_cabang']);

	// query insert data
	$query = "INSERT INTO expense VALUES ('', '$expense_name', '$expense_penerima', '$expense_date' , '$expense_create', '$expense_desc', '$expense_metode', '$expense_total_tagihan', '$expense_total_dibayar', '$expense_total_sisa', '', '', '$expense_cabang' )";
	mysqli_query($conn, $query);
...
function editExpense($data) {
	...
	$expense_total_dibayar = htmlspecialchars($data['expense_total_dibayar']);
	$expense_total_sisa    = $expense_total_dibayar - $expense_total_tagihan ;
	$expense_date_edit     = date("Y-m-d");
	$expense_user_edit     = htmlspecialchars($data['expense_user_edit']);

	// query update data
	$query = "UPDATE expense SET 
				expense_name          	= '$expense_name',
				expense_penerima      	= '$expense_penerima',
				expense_desc 			= '$expense_desc',
				expense_metode 			= '$expense_metode',
				expense_total_tagihan 	= '$expense_total_tagihan',
				expense_total_dibayar 	= '$expense_total_dibayar',
				expense_total_sisa 		= '$expense_total_sisa',
				expense_date_edit 		= '$expense_date_edit',
				expense_user_edit 		= '$expense_user_edit'
				WHERE expense_id 		= $id
				";
	mysqli_query($conn, $query);
	return mysqli_affected_rows($conn);
...
function hapusExpense($id) {
	global $conn;
	mysqli_query( $conn, "DELETE FROM expense WHERE expense_id = $id");
