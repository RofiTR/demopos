            ...
            <div class="invoice p-3 mb-3">
             ...
             <?php  
              ...
              <div class="row no-print">
                <div class="col-12">
				  <a href="nota-cetak-pembelian?no=<?= $invoice['invoice_pembelian_id']; ?>-invoice-<?= $id; ?>" target="_blank" class="btn btn-primary float-right"><i class="fas fa-print"></i> Print Invoice Kecil</a>
				  <a href="nota-cetak-pembelian-besar?no=<?= $invoice['invoice_pembelian_id']; ?>-invoice-<?= $id; ?>" target="_blank" class="btn btn-info float-right" style="margin-right: 5px;"><i class="fas fa-print"></i> Print Invoice Besar</a>
