        ...
        <div class="row mb-2">
          <div class="col-sm-8">
            ...
            <div class="btn-cash-piutang">
              ...
              <a href="beli-langsung?customer=<?= $_GET['customer']; ?>&r=MQ==" class="btn btn-warning" style='color: white'>Piutang</a>
              <?php else : ?>
                        ...
                        <table class="table">
                          <tr>
                              ...
                              <td class="table-nominal">
                                 <span>Rp. </span>
                                 <?php $totalParent = $total; ?>
                                 <span>
                                    <input type="text" name="" id="" class=""  value="<?= $total; ?>" size="10" readonly>
                                 </span>
                          ...
                          <tr>
                              ...
                              <td class="table-nominal">
                                 ...
                                 <span>
                                    <?php  
                                      $total += $invoice_pajak_nominal;
                                    ?>
                                    <input type="text" name="" id="angka2" class="a2"  value="<?= $total; ?>" onkeyup="return isNumberKey(event)" size="10" readonly>

                                    <input type="hidden" name="invoice_total" value="<?= $totalParent; ?>">
                                 </span>
