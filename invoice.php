            ...
            <div class="invoice p-3 mb-3">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                    ...
                    <?php  
                      ...
                      if ( $tipeTransaksi > 0 ) {
                        $channel = mysqli_query($conn, "SELECT cp_name FROM channel_pembayaran WHERE cp_id = $tipeTransaksi");
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <th>Pajak</th>
                        <td>
                            <?= $invoice['invoice_pajak']; ?>% (<?= $invoice['invoice_pajak_nominal']; ?>)
                        </td>
                      </tr>
                      <tr>
                        <th>Total + Pajak</th>
                        <?php  
                          $invoice_total_pajak = $invoice['invoice_total'] + $invoice['invoice_pajak_nominal'];
                        ?>
                        <td>Rp. <?= number_format($invoice_total_pajak, 0, ',', '.'); ?></td>
                      </tr>
                      <tr>
                        <th>Ongkir</th>
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <a href="nota-cetak?no=<?= $invoice['invoice_id']; ?>-invoice-<?= $id; ?>" target="_blank" class="btn btn-primary float-right"><i class="fas fa-print"></i> Print Invoice Kecil</a>
				  <a href="nota-cetak-besar?no=<?= $invoice['invoice_id']; ?>-invoice-<?= $id; ?>" target="_blank" class="btn btn-info float-right" style="margin-right: 5px;"><i class="fas fa-print"></i> Print Invoice Besar</a>
                  <a href="beli-langsung?customer=<?= base64_encode(0); ?>" class="btn btn-success float-right" style="margin-right: 5px;"> Kembali Transaksi</a>
                </div>
              </div>
            </div>
            <!-- /.invoice -->
