...
<script>
    $(document).ready(function(){
              ...
              },
              {
                "targets": -1,
                  ...
                  `<center class="orderan-online-button">
					  ...
					  <button class='btn btn-dark tblPrintbesar' title="Cetak Nota Besar">
                          <i class='fa fa-print'></i>
                      </button>&nbsp; 
					  
					  <button class='btn btn-secondary tblPrintjalan' title="Cetak Surat Jalan">
                          <i class='fa fa-print'></i>
                      </button>&nbsp; 
        ...
        $('#example1 tbody').on( 'click', '.tblPrint', function () {
		 ...
		 $('#example1 tbody').on( 'click', '.tblPrintbesar', function () {
            var data = table.row( $(this).parents('tr')).data();
            var data0 = data[0];
            window.open('nota-cetak-besar?no='+ data0, '_blank');
        });
		
		$('#example1 tbody').on( 'click', '.tblPrintjalan', function () {
            var data = table.row( $(this).parents('tr')).data();
            var data0 = data[0];
            window.open('nota-cetak-jalan?no='+ data0, '_blank');
        });
